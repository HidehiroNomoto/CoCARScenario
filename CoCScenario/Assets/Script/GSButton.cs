...
public class GSButton : MonoBehaviour {
    ...
    public void PushGSButton()
    {
        ...
        try { if (s1.objMake[3].activeSelf || s1.objMake[5].activeSelf) {AudioSource bgm = GameObject.Find("BGMManager").GetComponent<AudioSource>();bgm.loop=false; bgm.clip = s1.scenarioAudio[buttonNum]; bgm.Play(); } } catch { }
    }
}
